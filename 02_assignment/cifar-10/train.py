...
def validate(epoch, model, val_loader, writer):
    ...
    # draw accuracy curve!
    # ----------TODO------------
    writer.add_scalar('valid/top1', top1.avg, epoch)
    writer.add_scalar('valid/top5', top5.avg, epoch)
...
def train(epoch, model, optimizer, train_loader, writer):
    ...
    for imgs, labels in tqdm.tqdm(train_loader):
        ...
        if iteration % 50 == 0:
            ...
            writer.add_scalar('train/top1', acc1.item(), iteration)
            writer.add_scalar('train/top5', acc5.item(), iteration)
            # ----------TODO------------
